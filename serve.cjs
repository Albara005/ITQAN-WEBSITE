...
- **حقوق إتقان (إلزامي):** أضف في أسفل كل صفحة **سطر حقوق ثابتًا** (position:fixed; bottom:0; width:100%; text-align:center) بخط صغير أنيق، نصّه: «© 2026 إتقان — جميع الحقوق محفوظة · www.itqanoman.co». **لا تضع أي علامة مائية في خلفية الصفحة إطلاقًا** — فقط سطر الحقوق أسفل الصفحة.
