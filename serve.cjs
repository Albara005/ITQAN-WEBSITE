...
- **إخراج PDF مثالي (مهم جدًا):**
  • استخدم في CSS: @page { size: A4; margin: 0 } لإزالة رؤوس وتذييلات المتصفح تمامًا (التاريخ، الوقت، عنوان الصفحة، الرابط about:blank) — يجب ألا يظهر أي منها.
